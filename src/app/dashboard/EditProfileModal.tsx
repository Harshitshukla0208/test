                    ...
                    <form className="space-y-4" onSubmit={handleSave}>
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" value={firstName} onChange={(e) => setFirstName(e.target.value)} className="w-full p-3 border border-gray-300 rounded-lg text-gray-900 placeholder-gray-400" placeholder="Enter first name" />
                            </div>
                            <div>
                                <label className="block text-sm text-gray-700 mb-1">Last Name</label>
                                <input type="text" value={lastName} onChange={(e) => setLastName(e.target.value)} className="w-full p-3 border border-gray-300 rounded-lg text-gray-900 placeholder-gray-400" placeholder="Enter last name" />
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input
                                    ...
                                    readOnly
                                    disabled
                                    className="w-full p-3 border border-gray-300 rounded-lg text-gray-500 placeholder-gray-400 bg-gray-100 cursor-not-allowed"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full p-3 border rounded-lg text-gray-900 placeholder-gray-400 ${phoneRequiredEmpty ? 'border-red-400' : 'border-gray-300'}`}
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                {loadingBoards ? (
                                    ...
                                    <select value={board} onChange={(e) => setBoard(e.target.value)} className="w-full p-3 border border-gray-300 rounded-lg text-gray-900">
                            ...
                            <div>
                                ...
                                {loadingGrades ? (
                                    ...
                                    <select value={grade} onChange={(e) => setGrade(e.target.value)} className="w-full p-3 border border-gray-300 rounded-lg text-gray-900">
                        ...
                        {userType === 'Parent' && (
                            <div>
                                ...
                                <input type="text" value={studentName} onChange={(e) => setStudentName(e.target.value)} className="w-full p-3 border border-gray-300 rounded-lg text-gray-900 placeholder-gray-400" placeholder="Enter student name" />
                            </div>
                        )}
                        ...
                        <button
                            ...
                            className={`w-full py-3 bg-[#714B90] text-white rounded-lg font-semibold transition-colors ${!isFormValid ? 'opacity-60 cursor-not-allowed' : 'hover:bg-[#5a3a73]'}`}
                        >
                            Save Changes
                        </button>
                    </form>
